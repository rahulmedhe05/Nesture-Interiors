...
import { getKeywordContent, getDefaultKeywordContent } from "@/lib/keyword-content";
...
import { Phone, Mail, MapPin, CheckCircle, Star, Users, Award, Clock, Tag, Sparkles, Image as ImageIcon, ArrowRight, Quote, HelpCircle } from "lucide-react";
...
export function KeywordPageTemplate({ business, keyword, content }: KeywordPageTemplateProps) {
  ...
  const uniqueContent = getKeywordContent(keyword.slug) || getDefaultKeywordContent(keyword.slug, keyword.title);
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <BusinessHeroSlider 
        business={business} 
        area="vadodara" 
        heroTitle={uniqueContent.headline}
        heroSubtitle={uniqueContent.subheadline}
        keyword={keywordName}
      />
      ...
      {/* Main Intro Section - Human Written */}
      <section id="about" className="py-16 md:py-20">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center max-w-6xl mx-auto">
            <div className="order-2 md:order-1">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                {uniqueContent.headline}
              </h2>
              <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                <p className="text-lg leading-relaxed">{uniqueContent.intro}</p>
              </div>
              <div className="mt-8 space-y-4">
                {uniqueContent.benefits.map((benefit, index) => (
      ...
      <section className="py-16 bg-gradient-to-br from-blue-50 to-blue-100">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">Simple steps to your success</p>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {uniqueContent.processSteps.map((step, index) => (
      ...
      <section className="py-12 bg-blue-900 text-white">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-8 max-w-4xl mx-auto">
            {uniqueContent.trustPoints.map((point, index) => (
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-2xl md:text-3xl font-light italic mb-6 text-gray-700 leading-relaxed">
              "{uniqueContent.testimonial.quote}"
            </p>
            <div>
              <p className="font-bold text-lg">{uniqueContent.testimonial.name}</p>
              <p className="text-gray-500">{uniqueContent.testimonial.detail}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center">
            <HelpCircle className="inline-block w-8 h-8 mr-2 text-blue-600" />
            Common Questions
          </h2>
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">Answers to what most people ask us</p>
          <div className="max-w-3xl mx-auto space-y-6">
            {uniqueContent.faq.map((item, index) => (
              <div key={index} className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <h3 className="text-lg font-bold mb-2 text-gray-800">{item.q}</h3>
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 text-center text-white">
          <h2 className="text-3xl md:text-5xl font-bold mb-4">{uniqueContent.cta}</h2>
          <p className="text-lg md:text-xl opacity-90 mb-8 max-w-2xl mx-auto">
            Let's find the perfect property for your future in Vadodara
          </p>
